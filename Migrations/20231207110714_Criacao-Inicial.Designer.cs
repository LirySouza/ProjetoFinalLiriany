...
namespace ProjetoFinalLiriany.Migrations
{
    ...
    [Migration("20231207110714_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Cidade", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Colaborador", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Estado", b =>
                {
                    b.Property<int>("EstadoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.LocalRealizacao", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Procedimento", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.ProcedimentoRealizacao", b =>
                {
                    b.Property<int>("ProcedimentoRealizacaoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ProcedimentoRealizaçãoId");
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.TipoColaborador", b =>
                {
                    b.Property<int>("TipoColaboradorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.TipoProcedimento", b =>
                {
                    b.Property<int>("TipoProcedimentoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalLiriany.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalLiriany.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalLiriany.Models.TipoColaborador", "TipoColaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalLiriany.Models.TipoProcedimento", "TipoProcedimento")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalLiriany.Models.ProcedimentoRealizacao", b =>
                {
                    b.HasOne("ProjetoFinalLiriany.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId");

                    b.HasOne("ProjetoFinalLiriany.Models.Colaborador", "Colaborador")
                        .WithMany()
                        .HasForeignKey("ColaboradorId");

                    b.HasOne("ProjetoFinalLiriany.Models.LocalRealizacao", "LocalRealizacao")
                        .WithMany()
                        .HasForeignKey("LocalRealizacaoId");

                    b.HasOne("ProjetoFinalLiriany.Models.Procedimento", "Procedimento")
                        .WithMany()
