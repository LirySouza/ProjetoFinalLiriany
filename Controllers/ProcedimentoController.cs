...
namespace ProjetoFinalLiriany.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        {
            ViewData["TipoProcedimentoId"] = new SelectList(_context.TipoProcedinho, "TipoProcedimentoId", "TipoProcedimentoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoObservacao,TipoProcedimentoId")] Procedimento procedimento)
        {
            ...
            ViewData["TipoProcedimentoId"] = new SelectList(_context.TipoProcedinho, "TipoProcedimentoId", "TipoProcedimentoNome", procedimento.TipoProcedimentoId);
            return View(procedimento);
        }
